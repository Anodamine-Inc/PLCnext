...
PLC_URL = 'https://localhost/_pxc_api/api/variables/?pathPrefix=Arp.Plc.Eclr/&paths=PRC_P1_On,PRC_P1_Enabled,PRC_P2_On,PRC_P2_Enabled,PRC_P1_AutoControl,PRC_P2_AutoControl,PRC_P1_DosageRate,PRC_P2_DosageRate,PRC_P1_TotalDosed_Liters,PRC_P2_TotalDosed_Liters,PRC_P1_MotorFreq,PRC_P2_MotorFreq,PRC_P1_Alarm,PRC_P2_Alarm,PRC_Level_Liters,PRC_Level_mm,PRC_Stats_Counter_Batches,PRC_Stats_TotalVolumeInjected_Liters,PRC_Stats_Counter_P1_Starts,PRC_Stats_Counter_P2_Starts,PRC_AI_1,PRC_AI_2,PRC_Stroke_Setting,PRC_Stroke_SettingP2,PRC_Pump_Max_mL_min,PRC_Pump_Max_mL_minP2,PRC_Pressure_PSI,PRC_P1_TotalRunTime,PRC_P2_TotalRunTime,PRC_TotalPLCTime,PRC_Info_PLCFirmwareVer,PRC_Info_PLCProjVer,PRC_Info_Serial,PRC_Dosage_Rate_8HR,PRC_Dosage_Rate_24HR,MB_Tote_Days_Remaining'
WEBHOOK_URL = 'https://plc.anodamine.com/api/v1/data'

filepaths = glob.glob('/opt/plcnext/config-*.ini')
config = configparser.ConfigParser()
config.read(filepaths[0])
plcId = config['CONFIG']['plcId']
hmacKey = config['CONFIG']['hmacKey']
...
def get_payload(data, plcId, hmacKey, apiKey):
...
if data is None:
    ...
    payload, hmac_key, api_key = get_payload(data, plcId, hmacKey, apiKey)
